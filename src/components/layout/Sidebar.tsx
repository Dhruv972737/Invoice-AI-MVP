...
const navigation = [
  ...
  { name: 'Upload Invoice', icon: Upload, view: 'upload' },
  { name: 'All Invoices', icon: FileText, view: 'invoices' },
  { name: 'AI Assistant', icon: MessageSquare, view: 'chat' },
      ...
      `}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">InvoiceAI</h1>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
