...
const quickQueries: QuickQuery[] = [
  { text: "Show me high-risk invoices", query: "Show me all invoices with high fraud risk" },
  { text: "Total spent this month", query: "What's the total amount spent this month?" },
  { text: "VAT summary", query: "Give me a summary of VAT amounts by region" },
  { text: "Top vendors", query: "Who are my top vendors by invoice count?" },
  { text: "Pending invoices", query: "Show me all invoices that are still processing" },
  { text: "Monthly trends", query: "Show me monthly spending trends" }
];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'bot',
      content: 'Hi! I\'m your AI invoice assistant powered by Google Gemini. I can help you analyze your invoices, find specific information, and provide insights about your spending patterns. What would you like to know?',
      timestamp: new Date()
    }
  ]);
    ...
    <div className="max-w-4xl mx-auto h-[calc(100vh-200px)] flex flex-col">
      ...
      <div className="bg-white dark:bg-gray-800 px-4 py-3 border-x border-gray-200 dark:border-gray-700">
        <div className="flex items-center mb-2">
          ...
          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Quick Queries:</span>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-4 rounded-b-xl shadow-sm border border-gray-200 dark:border-gray-700 border-t-0">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
          {geminiService 
            ? 'AI responses are generated by Google Gemini based on your invoice data'
            : 'Responses are generated using pattern matching - configure Gemini API for better results'
          }
        </p>
      </div>
    </div>
