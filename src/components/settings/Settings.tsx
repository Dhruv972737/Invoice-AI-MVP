...
export default function Settings() {
  ...
  const deleteAccount = async () => {
    try {
      ...
      showToast('success', 'Account deleted', 'Your account and data have been deleted');
      await signOut();
    } catch (error: any) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="p-6 space-y-4">
          {[
            ...
            { key: 'processing', label: 'Processing updates', desc: 'Get notified when invoices are processed' },
            { key: 'security', label: 'Security alerts', desc: 'Important security and login notifications' },
              ...
              <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Are you sure you want to delete your account? This action cannot be undone and will permanently remove all your data, including invoices and settings.
                      </p>
                    </div>
                  </div>
                </div>
